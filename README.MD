...
These exercises are part of the "VS Code Can Do That" workshop from TechLabs Berlin, adapted from the same workshop on Frontend Masters.
...
- [VS Code Can Do That extension pack](bit.ly/tlb-vscode)
